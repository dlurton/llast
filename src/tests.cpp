...
{
    const float allowedVariance = 0.000001f;
...
TEST_CASE("Float tests") {
    ...
    REQUIRE(execFloatBinary(1.1f, OperationKind::Add, 2.2f, 3.3f));
    REQUIRE(execFloatBinary(6.2f, OperationKind::Sub, 1.1f, 5.1f));
    REQUIRE(execFloatBinary(5.25f, OperationKind::Mul, 3.0f, 15.75f));
    REQUIRE(execFloatBinary(7.0f, OperationKind::Div, 2.0f, 3.5f));
